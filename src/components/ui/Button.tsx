...
export default function Button({
  ...
  const base =
    "inline-flex items-center justify-center px-4 py-2.5 md:px-5 text-sm font-medium rounded-xl transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-offset-2";

  const variants: Record<Variant, string> = {
    primary:
      "bg-[var(--color-primary)] text-white hover:opacity-95 shadow-sm hover:shadow focus:ring-[var(--color-primary)]",
