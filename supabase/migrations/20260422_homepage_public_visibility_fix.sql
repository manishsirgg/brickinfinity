-- Ensure all non-deleted listings are publicly visible on homepage/listing pages.
-- This restores visibility for newly listed properties that are awaiting moderation.
