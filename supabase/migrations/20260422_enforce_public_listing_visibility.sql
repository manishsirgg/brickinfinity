-- Finalize public listing visibility rules.
-- Any visitor (anonymous or logged-in) can read active, approved, non-deleted listings
-- along with their media and location references.
...
-- Location tables needed by listing/detail joins
